...
>
> Практический вывод: субъективное качество результата (прослушивание / вычитание в DAW) **систематически лучше**, чем показывает число в job-статусе. Оценивайте результат по WAV, а не только по проценту.
