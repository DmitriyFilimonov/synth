...
**После исправления:** `startLevel` масштабирует амплитуду огибающей. Осцилляторы теперь имеют реальную громкость, scale fitting работает с реальным параметром, а клиппинг (п. 5) должен уменьшиться.
