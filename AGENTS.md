...
- Текущее плато ~50% (анализ в `README.md`) — известное промежуточное
  состояние, а не цель: изменения не должны его деградировать,
...
| После каждого выполненного задания                   | `criteria-match`                  | Сводная проверка соответствия критериям проекта |
